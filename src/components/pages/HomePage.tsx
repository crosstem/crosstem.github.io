  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 bg-white dark:bg-gray-900">
      <header className="w-full max-w-5xl mx-auto flex justify-end items-center p-4">
        <button onClick={() => changeLanguage('en')} className="text-gray-700 dark:text-gray-300 mx-2">English</button>
        <button onClick={() => changeLanguage('ja')} className="text-gray-700 dark:text-gray-300 mx-2">日本語</button>
      </header>
      <main className="flex flex-col items-center justify-center flex-grow">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-center text-gray-900 dark:text-white mb-4">{t('title')}</h1>
